...
const Dashboard: React.FC = () => {
  ...
  const [repositories, setRepositories] = useState<Repository[]>(() => {
    const storedRepositories = localStorage.getItem('@FirstReactProject:repositories');
  ...
  useEffect(() => {
    localStorage.setItem('@FirstReactProject:repositories', JSON.stringify(repositories));
  }, [repositories]);
